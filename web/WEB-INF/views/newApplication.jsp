...
//                console.log("tripper 1  ", tripper);
                document.getElementById('task').value = 'Start New Application';
            });
        </script>
                                                ...
                                                <div class="panel-body">
                                                    <div class="col-md-4" style="margin-top: 40px; margin-bottom: 20px">                                              
                                                        ...
                                                        <div class="input-group pull-left" style="margin-bottom: 20px">
                                                            ...
                                                            <input type="text" class="form-control pull-left" name="translatorFee" id="translatorFee" placeholder="fee" required="">    
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4" style="margin-top: 40px; margin-bottom: 20px">  
                                                        ...
                                                        <div class="form-group">
                                                            <!--keep in one line otherwise placeholder doesn't show-->
                                                            <textarea class="form-control" placeholder="Break-down of translator fee" name="BreakDownOfTranslatorFee" id='BreakDownOfTranslatorFee' style="width: 280px; height: 196px;" required="" ></textarea>
                                                        </div>
                                                    </div>
                                                </div>  <!--panel--body-->
                                            </div> <!--panel-default-->
