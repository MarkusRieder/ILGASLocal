                ...
                <div class="container-fluid" style="margin-bottom: 20px; width: 100%">
                    ...
                    <div class="row" style="margin-bottom: 15px">
                        ...
                        <div class="col-md-6" style="margin-bottom: 50px; margin-top: 50px;">
                            <h3>The following files have been successfully updated:</h3><br/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" style="margin-bottom: 50px;">
                            <div>
                                <strong>Thank you - the application has been updated.</strong> <br/>
                            </div>
                        </div>
                    </div>


                    <form id="returnToStaffServlet" 
                          class="form-horizontal" 
                          action="${pageContext.request.contextPath}/returnToStaffServlet" 
                          method="POST"  
                          role="form" 
                          >
