...
<html style="height: 100%" >
    <head>
        ...
        <!--welcome_Staff_1-->
        <script  type="text/javascript"  src="js/welcome_StaffFormValidator.js"></script>
        <script  type="text/javascript" src="js/welcome_Staff_1.js"></script>
...
//
////                $('#showInstructionsModal .modal-dialog').draggable({
////                    handle: ".modal-header"
////                });
//
