...
//                    document.getElementById("addendum").href = addendumRightsAgreemnt;
        ...
        proofOfPaymentToTrans = 'https://www.literatureirelandgrantapplication.com' + rowdata.proofOfPaymentToTranslator + '';
        ...
        bankDetailsFrm = 'https://www.literatureirelandgrantapplication.com' + rowdata.bankDetailsForm + '';
        ...
        signedLIContr = 'https://www.literatureirelandgrantapplication.com' + rowdata.SignedLIContract + '';
...
//                        var cver = 'https://www.literatureirelandgrantapplication.com' + rowdata.cover + '';
//                        $("#cover").val(cver);
//                        document.getElementById("cover").src = cver;
//                    }
...
//
//                    var trans = 'https://www.literatureirelandgrantapplication.com' + rowdata.translatorCV + '';
...
//                    $("#appAgreement").val($(this).closest('tr').children()[5].textContent);
        ...
        console.log("ReferenceNumber 12 referenzNummer  " + referenzNummer);
        console.log("ReferenceNumber 12 ReferenceNumber  " + ReferenceNumber);
...
function backToMisc() {
    ...
    console.log("pressCuttingArray.length", pressCuttingArray.length);
    ...
    if (window.File && window.FileList && window.FileReader)
    {
        $('#files').on("change", function (event) {
            ...
            for (var i = 0; i < files.length; i++)
            {
                ...
                console.log("files on change fileName  " + fileName);
...
//           var preview = document.getElementById("preview");
        ...
        for (var i = 0; i < elem.files.length; ++i) {
            ...
            pressCuttingArray.push(elem.files[i].name);
        }
        var form = $("#coverageCuttingsForm")[0];
        var data = new FormData(form);

        console.log("coverageCuttingsForm");
        console.log(data);

        $("#input25").change(function () {
            var $this = $(this), $clone = $this.clone();
            console.log("$this   ");
            console.log($this);
            $this.after($clone).appendTo('pressCuttingsClone');
        });
...
//                    console.log("showFile ReferenceNumber " + ref + " pub " + pub);
        ...
        for (var i = 0; i < fileInput.files.length; i++) {
            console.log("1 fileInput.files[i]");

            console.log(fileInput.files[i]);
            var reader = new FileReader();
            reader.onload = function (readerEvent) {
                console.log("2 fileInput.files[i]");
                console.log(fileInput.files[i]);
...
//                        console.log("ReferenceNumber 34 " + './coverageCuttingsUploadServlet?ReferenceNumber=' + ReferenceNumber.value + '&publisherName=' + $("#publisherName").val());
            var oops = reader.readAsDataURL(fileInput.files[i]);
            console.log("oops");
            console.log(oops);
        }
    }
...
function saveCuttings() {
    var form = $("#coverageCuttingsForm")[0];
    var data = new FormData(form);
    console.log("ReferenceNumber 123 " + referenzNummer + ' FormData = ' + data);


    var newURLcoverageCuttingsUploadServlet = './coverageCuttingsUploadServlet?ReferenceNumber=' + referenzNummer + '&publisherName=' + $("#publisherName").val();
    console.log("ReferenceNumber 123 newURLcoverageCuttingsUploadServlet  " + newURLcoverageCuttingsUploadServlet);

    $.ajax({
        type: "POST",
        dataType: 'json',
        encType: "multipart/form-data",
        url: newURLcoverageCuttingsUploadServlet,
        cache: false,
        processData: false,
        contentType: false,
        data: data,
        success: function (msg) {
            ...
            console.log("newURLcoverageCuttingsUploadServlet");
            console.log(response);
            var status = response.status;
            if (status === 1) {
                alert("File has been uploaded successfully");
            } else {
                console.log("newURLcoverageCuttingsUploadServlet  msg " + JSON.parse(msg));
                alert("Couldn't upload file");
            }
        },
        error: function (msg) {
            console.log("newURLcoverageCuttingsUploadServlet  msg " + msg);
            alert("Couldn't upload file");
        }
    });
...
//    document.getElementById("pressCuttingArray").value = document.getElementById("input25").value;
...
function loadFileinput() {
    ...
    var newURLcoverageCuttingsUploadServlet = './coverageCuttingsUploadServlet?ReferenceNumber=' + referenzNummer.value + '&publisherName=' + $("#publisherName").val();
...
//                 console.log("ReferenceNumber 34 newURL " + newURLcoverageCuttingsUploadServlet);
    $("#input25").fileinput('refresh', {
        ...
        uploadExtraData: {ReferenceNumberABC: referenzNummer.value, publisherNameABC: $("#publisherName").val()},
        'allowedFileExtensions': ["jpg", "gif", "png", "pdf"],
        // ≈ 1.4mb
        'maxFileSize': 1400,
        'overwriteInitial': true
...
$(document).ready(function () {
    var username = document.getElementById("username1").value;
    console.log("username pendingApplication ", username);
