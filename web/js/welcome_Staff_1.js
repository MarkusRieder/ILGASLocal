            ...
            {"data": "cover",
                "render": function (data, type, row) {
                    if (typeof (data) === "undefined") {
                        ...
                        return '<img src="http://localhost:8080/ILGASLocal/images/not-available.jpg" width="275" height="275" alt="not-available"/>';
                    } else {
...
//                    console.log("lib q17 ??? " + $(this).closest('tr').children()[17].textContent);
        ...
        if (typeof (rowdata.cover) === "undefined") {
            var cver = 'http://localhost:8080/ILGASLocal/images/not-available.jpg';
        } else {
...
function selectTemplate1(e) {
    $('#selectTemplate').fileTree({root: '/home/markus/uploads/', script: 'connectors/jqueryFileTree.jsp'}, function (file) {
        ...
        console.log(e);
        console.log("selectTemplate:  " + file);
    });
}
//});
...
//                if (!($('#showInstructionsModal .modal.in').length)) {
//                    $('.modal-dialog').css({
//                        top: 0,
//                        left: 0
//                    });
//                }
//                $('#showInstructionsModal').modal({
//                    backdrop: false,
//                    show: true
//                });
