...
public class closedApplicationDAO {

    private static final Logger LOGGER = Logger.getLogger( closedApplicationDAO.class.getName() );
    ...
    public static ArrayList getAllApplications( String parameter ) throws ClassNotFoundException, DBException
    {
        ...
        System.out.println( "closedApplicationDAO  Publisher here: " + parameter );
        ArrayList<String> translatorList;
        List<List<String>> listOfTranslatorArray;
        List<List<String>> rightsAgreementArray;

        String searchQuery = "SELECT * FROM ILGAS.GrantApplication WHERE Status = 'closed' AND publisherID = " + parameter + " ORDER BY ApplicationYear ";
...
//                application.setExpertReaderName(expertReaderName);
    ...
    public static List<GrantApplication> getAllApplicationsPublisher( String publisherID ) throws ClassNotFoundException, DBException, ParseException
    {
        ...
        System.out.println( "publisherID Local closedApplicationDAO  getAllApplicationsPublisher  " + publisherID );
        ...
        if ( GrantApplicationData == null )
        {
            ...
            PreparedStatement ps = null;
            ResultSet res = null;
            System.out.println( "getAllApplicationsPublisher Local closedApplicationDAO  here " );
            ...
            String searchQuery = "SELECT * FROM ILGAS.GrantApplication WHERE  publisherID = '" + publisherID + "' AND Status = 'closed' ORDER BY ApplicationYear, ApplicationNumber";
            System.out.println( "getAllApplicationsPublisher Local closedApplicationDAO searchQuery  " + searchQuery );
            try
            {
                ...
                res = ps.executeQuery( searchQuery );
                System.out.println( "searchQuery closedApplicationDAO   " + searchQuery );
                while ( res.next() )
                {
...
//                   //  System.out.println("<==================================================================================");
            ...
            } catch ( ClassNotFoundException | SQLException e )
            {
                LOGGER.debug( e.getMessage() );
                DBConn.close( conn, ps, res );
                throw new DBException( "closedApplicationDAO 12 Excepion while accessing database" );
            }
...
//                    auth = new ArrayList<>();
    ...
    public static String getTranslatorNames( String translatorTrackId ) throws ClassNotFoundException, SQLException
    {
        ...
        {
            java.util.logging.Logger.getLogger( closedApplicationDAO.class.getName() ).log( Level.SEVERE, null, ex );
        }
...
//        This is not the full pojo - only fields relevant to closed update
