...
//                   //  System.out.println("<==================================================================================");
    ...
    public static List<EntryDb> getEntryDb1( String status ) throws ClassNotFoundException, DBException
    {
        ...
        searchQuery = "SELECT ReferenceNumber, company, Status  FROM GrantApplication WHERE Status ='" + status + "' ORDER BY ApplicationYear";
        System.out.println( "Test1DAO  getEntryDb searchQuery  " + searchQuery );
...
//                        }
    ...
    public static boolean updateApplication( GrantApplication app, String ApplicationNumber, String applicationYear ) throws SQLException, DBException, ClassNotFoundException, MessagingException
    {
        ...
        try
        {
            ...
            if ( res != null )
            {
                while ( res.next() )
                {
                    ...
                    pressCoverageArray[ 0 ] = "http://localhost" + fileName;
                    ...
                    if ( "pdf".equals( extension ) )
                    {
                        ...
                        pressCoverageArray[ 2 ] = "http://localhost" + thumbFullPath;
