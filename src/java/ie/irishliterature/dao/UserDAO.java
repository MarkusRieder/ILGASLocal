...
//                    expertReader.setROLE(res.getString("role"));
        ...
        } catch ( ClassNotFoundException | SQLException e )
        {
            LOGGER.debug( e.getMessage() );
            DBConn.close( conn, ps, res );
            throw new DBException( "12 getAllExpertReaders Excepion while accessing database" );
        }
        ...
        try
        {
            ...
            if ( res != null )
            {
                while ( res.next() )
                {
                    ...
                    Staff.setFull_NAME( res.getString( "fullName" ) );
...
//                    expertReader.setROLE(res.getString("role"));
        ...
        } catch ( ClassNotFoundException | SQLException e )
        {
            LOGGER.debug( e.getMessage() );
            DBConn.close( conn, ps, res );
            throw new DBException( "12 getAllStaff Excepion while accessing database" );
        }
