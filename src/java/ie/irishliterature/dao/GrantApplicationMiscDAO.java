...
public class GrantApplicationMiscDAO {
    
     private static final org.apache.log4j.Logger LOGGER = org.apache.log4j.Logger.getLogger( GrantApplicationMiscDAO.class.getName() );
    ...
    public static int getSizeOfApplications() throws DBException {
        ...
        try {
            ...
            Logger.getLogger( GrantApplicationMiscDAO.class.getName() ).log( Level.SEVERE, null, e );
...
//                   //  System.out.println("<==================================================================================");
    ...
    public static List<EntryDb> getEntryDb() throws ClassNotFoundException, DBException {
        ...
        System.out.println( "GrantApplicationMiscDAO  getEntryDb searchQuery  " + searchQuery );
        ...
        DBConn.close( conn, ps, res );
        System.out.println( "GrantApplicationMiscDAO  counter  " + counter );
...
//            System.out.println( "getBookTitle :: ps " + ps );

            if ( res != null ) {
                while ( res.next() ) {

                    authorList = authorList + " " + res.getString( 1 );
//                    System.out.println( "getAuthor :: authorList " + res.getString( 1 ) );
            ...
            java.util.logging.Logger.getLogger( GrantApplicationMiscDAO.class.getName() ).log( Level.SEVERE, null, ex );
        }
...
//            updateQuery += " Status ='" + app.getStatus() + "',";
            ...
            DBConn.close( conn, ps1, res );
            throw new DBException( "GrantApplicationMiscDAO updateApplication 4 Excepion while accessing database" + e );
        }
...
//             System.out.println( "updateApplication approveWithdrawnReject isEmpty");
//         }
//                  if ( approveWithdrawnRejectSelected == null) {
//             System.out.println( "updateApplication approveWithdrawnReject null");
//         }
//                           if ( "null".equals( approveWithdrawnRejectSelected )) {
//             System.out.println( "updateApplication approveWithdrawnReject nullnull");
//         }
...
//                Logger.getLogger( EntryDbDAO.class.getName() ).log( Level.SEVERE, null, e );
...
//                Logger.getLogger( EntryDbDAO.class.getName() ).log( Level.SEVERE, null, e );
    ...
    public static ArrayList<String> getPreviousGrantAid( String appRef ) throws DBException {
        ...
        System.out.print( "GrantApplicationMiscDAO  previousGrantAid :  " + previousGrantAid.toString() );
...
//                       //  System.out.println("GrantApplicationMiscDAO getTranslatorTrack  setTranslatorName: " + res.getString(1) + " for TranslatorTrackId " + TranslatorTrackId);
//                       //  System.out.println("GrantApplicationMiscDAO getTranslatorTrack  testList: " + res.getString(1) + " for TranslatorTrackId " + TranslatorTrackId);
//                    }
//
//                    idx++;
//
...
//                   //  System.out.println("GrantApplicationMiscDAO getTranslatorTrack  auth: " + res.getString(3) + " for TranslatorTrackId " + TranslatorTrackId);
//                    testList.add(auth);
//                    titleList.add(res.getString(2));
//                   //  System.out.println("GrantApplicationMiscDAO getTranslatorTrack  titleList: " + res.getString(2) + " for TranslatorTrackId " + TranslatorTrackId);
//                    testList.add(res.getString(2));
            ...
            //  System.out.println("GrantApplicationMiscDAO getTranslatorTrack  translatorTracker: " + translatorTracker + " for TranslatorTrackId " + TranslatorTrackId);
        ...
        DBConn.close( conn, ps, res );
        //  System.out.println("GrantApplicationMiscDAO getTranslatorTrack  testList: " + testList + " for TranslatorTrackId " + TranslatorTrackId);
    ...
    public static ArrayList<String> getTranslatorTrackId( String appRef ) {
        ...
        System.out.println( "GrantApplicationMiscDAO getTranslatorTrackId " + translatorTrackID );
    ...
    public static ArrayList<String> getAuthors( String appRef ) {
        ...
        //  System.out.println("GrantApplicationMiscDAO  getAuthors authorList: " + authorList);
        return authorList;
    }
...
//                    System.out.println( "getBookTitle :: bookTitle[0] " + res.getString( 1 ) );
//                    System.out.println( "getBookTitle :: bookTitle[1] " + res.getString( 2 ) );
//
//                    System.out.println( "getBookTitle referenceNumber   " + appRef + "  Title " + bookTitle[0] );
//                    System.out.println( "getBookTitle referenceNumber   " + appRef + "  Genre " + bookTitle[1] );
    ...
    public static List<String> getUnassignedExpertReader() {
        ...
        //  System.out.println("GrantApplicationMiscDAO entering expertReader.... ");
    ...
    public static ArrayList<String> getTranslatorTracker( String TranslatorTrackId ) throws DBException {
        ...
        try {
            ...
            while ( res.next() ) {
                ...
                System.out.println( "GrantApplicationMiscDAO getTranslatorTracker  translator: " + res.getString( 1 ) + " author: " + res.getString( 2 ) + " title: " + res.getString( 3 ) + " ReferenceNumber: " + res.getString( 4 ) );
        ...
        for ( int u = 0; u < resultList.size(); u++ ) {
            System.out.println( "GrantApplicationMiscDAO resultList " + u + "  " + resultList.get( u ) );
        }
...
//     int ifIfAuthorExist =  ifAuthorExist( authorArray[0] );
//                
//                if( ifIfAuthorExist > 0 )){
...
//           //  System.out.println("ps: " + ps);
    ...
    public static ArrayList<String[]> getDocuments( String appRef ) {
        ...
        DBConn.close( conn, ps, res );
        //  System.out.println("GrantApplicationMiscDAO getDocuments for ReferenceNumber: " + appRef);
