...
//        }
        ...
        company = request.getParameter("publisherName");
                ...
                for (FileItem item : multiparts) {
                    ...
                    if (!item.isFormField()) {
                        ...
                        if (type != null) {
                            ...
                            if ("pdf".equals(ext)) {
                                /*
                                 * if we have a pfd-file we need thumbfiles (jpg)
                                 * 
                                 * 
                                 */
                        ...
                        /*
                         * That's where the moveFileName has been written to disk
                         * /home/markus/public_html/test/2019/Discworld Publishers/50/CoverageCuttings/test.pdf
                         */
                        moveFileName = filePath + fileName;
                        System.out.println(">>>  CoverageCuttings::  moveFileName " + moveFileName);
                        /*
                         * before writing to database we need to make some changes to the path
                         * moveFileName.replace("/home/markus/public_html", "/~markus");
                         * so we have
                         * /~markus/test/2019/Discworld Publishers/50/CoverageCuttings/test.pdf
                         */
                        String moveFileNameReplaced = moveFileName.replace("/home/markus/public_html", "/~markus");
    ...
    enum Type {
        ...
        IMAGES("/home/markus/test/tempDir", ".jpg", ".bmp", ".gif", ".png", ".jpeg", ".pdf"),
