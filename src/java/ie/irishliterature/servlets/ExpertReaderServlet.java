...
public class ExpertReaderServlet extends HttpServlet {
            ...
            throws ServletException, IOException
    {
        ...
        /**
         * set expertReader.reading = "false" as we want to show even reading
         * ExpertReaders
         * Originally this was set to exclude ExpertReaders who are already
         * reading
         */
        Status = "false";
...
//                        case "expertReaderReport":
                        case "ExpertReaderReport":
                            if ( filename.isEmpty() )
                            {
                                System.out.println( "ExpertReaderReport is empty  filename " + filename );
                            } else
                            {
                        ...
                        case "ExpertReaderInvoice":
                            if ( filename.isEmpty() )
                            {
                                System.out.println( "ExpertReaderInvoice is empty  filename " + filename );
                            } else
                            {
                                filePath = tempPath + File.separator + yearInString + File.separator + company + File.separator
...
/*
                     ...
                     */
                    System.out.println( "create temporary Directory if it does not exist " + fileName + " filePath " + filePath );
                    if ( filename.isEmpty() )
                    {
...

            {
                try
                {
                    ExpertReaderDAO.updateExpertReader( expertReader, ReferenceNumber );
...
//                String moveFileNameReplaced = moveFile.replace("/home/glassfish/glassfish/domains/domain1/docroot/documents", "/documents");
    ...
    public static String findPublisherName( String ReferenceNumber ) throws DBException
    {
        ...
        System.out.println( "findPublisherName for ReferenceNumber : " + ReferenceNumber );
