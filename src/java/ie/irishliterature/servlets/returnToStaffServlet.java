 ...
 * @author markus
 */
@WebServlet( name = "returnToStaffServlet", urlPatterns
        = {
            "/returnToStaffServlet"
        } )
public class returnToStaffServlet extends HttpServlet {
    ...
    protected void processRequest( HttpServletRequest request, HttpServletResponse response )
        ...
        System.out.println( "############################### /returnToStaffServlet ####################################" );
