...
public class CheckUserName extends HttpServlet {
    ...
    {
        System.out.println( "CheckUserName Local connect " );
        if ( connection == null || connection.isClosed() )
        {
            System.out.println( "CheckUserName Local connect if (connection == null || connection.isClosed())" );
            connection = getConnection( Setup.DB_URL, Setup.DB_USERNAME, Setup.DB_PASSWORD );
            System.out.println( "CheckUserName Local getConnection " + connection );
        }
    }
