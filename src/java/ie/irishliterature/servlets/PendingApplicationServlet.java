...
/**
 * Servlet implementation class PendingApplicationServlet
 * <br>
...
//compare with openapplicationservlet
//        switch ( task ) {
//            case "Pending Applications":
//                System.out.println( "Here we are >>>>>>>>>.   Pending Applications :: PendingApplicationServlet" );
        Status = request.getParameter( "Status" );

        System.out.println( "PendingApplicationServlet :: Status: " + Status );
        /*
         * set Status
         * removed as it's now hadled by staff
         */
//        Status = "pending";
        ...
        try {
            ...
            for ( FileItem item : items ) {
                if ( item.isFormField() ) {
                    ...
                    System.out.println( "List fieldnames " + fieldname + " and fieldvalues  >> " + fieldvalue );
                    ...
                    switch ( fieldname ) {
                        ...
                        case "authorArray":
                            ...
                            //                System.out.println("authorArraylength  PendingApplicationServlet:: " + authorArray.length);
                            for ( String individualValue : authorArray ) {
                                //                    System.out.println("authorArray  PendingApplicationServlet:: " + individualValue);
                            }
                            break;
                        case "AuthorFirstName":
                            AuthorFirstName = fieldvalue;
                            //                 System.out.println("AuthorFirstName PendingApplicationServlet:: " + AuthorFirstName);
                            break;
                        case "AuthorLastName":
                            AuthorLastName = fieldvalue;
                            //              System.out.println("AuthorLastName PendingApplicationServlet:: " + AuthorLastName);
                            break;
                        case "bookTitle":
                            Title = fieldvalue;
                        ...
                        case "translationPublicationYear":
                            ...
                            break;
                                                    case "Status":
                            Status = fieldvalue;
                            System.out.println( "Status  PendingApplicationServlet:: " + Status );
                            break;
                        case "translatorArray":
                            ...
                            for ( String individualValue : translatorArrayContent ) {
                                System.out.println( "translatorArray  PendingApplicationServlet:: " + individualValue + " ----------> translatorArrayLength::  " + translatorArrayLength );
                            }
                            break;
                        case "rightsHolderArray":
                            ...
                            for ( String individualValue : rightsHolderArrayContent ) {
                                System.out.println( "rightsHolderArray  PendingApplicationServlet:: " + individualValue + " ----------> rightsHolderArrayLength::  " + rightsHolderArrayLength );
                            }
                            break;
                        case "languages":
                            languageArray = fieldvalue.split( "," ); //split string by ,
                            for ( String individualValue : languageArray ) {
                                //                  System.out.println("languageArray  PendingApplicationServlet:: " + individualValue);
                            }
                            break;
                        ...
                        case "pressCuttingArray":
                            ...
                            for ( String individualValue : pressCuttingArrayContent ) {
                                System.out.println( "pressCuttingArray  PendingApplicationServlet:: " + individualValue + " ----------> pressCuttingArrayContent.length::  " + pressCuttingArrayContent.length );
                            }
                            break;
                    ...
                    if ( !filename.isEmpty() ) {
                        ...
                        System.out.println( "switch ( " + fieldname + ")" );
                        ...
                        switch ( fdname ) {
                            ...
                            case "Cover":
                                ...
                                System.out.println( "Cover switch fileNames[idxFolderNames]: " + fileNames[idxFolderNames] );
                                filesToBeMoved.add( fileNames[idxFolderNames] );
                                break;
                            case "proofPayment":
                                ...
                                System.out.println( "proofPayment switch fileNames[idxFolderNames]: " + fileNames[idxFolderNames] );
                                filesToBeMoved.add( fileNames[idxFolderNames] );
                                break;
                            case "bankDetailForm":
                                ...
                                System.out.println( "bankDetailForm switch fileNames[idxFolderNames]: " + fileNames[idxFolderNames] );
                                filesToBeMoved.add( fileNames[idxFolderNames] );
                                break;
                            case "signedLIcontract":
                                filePath = tempPath + File.separator + yearInString + File.separator + company + File.separator
                                ...
                                System.out.println( "signedLIcontract switch fileNames[idxFolderNames]: " + fileNames[idxFolderNames] );
                                filesToBeMoved.add( fileNames[idxFolderNames] );
                                break;
...
//                                        System.out.println("CoverageCuttings switch fileName: " + filename + " filePath " + filePath);
                                    ...
                                    System.out.println( "CoverageCuttings switch fileName: " + filename + " filePath " + filePath );
                                    System.out.println( "CoverageCuttings switch fileNames[idxFolderNames]: " + fileNames[idxFolderNames] );
                                    filesToBeMoved.add( fileNames[idxFolderNames] );
                                }
                                break;
                        } // end switch
 ...
 /*
             ...
             */
            System.out.println( "PendingApplicationServlet ReferenceNumber: " + ReferenceNumber );

            int iend = ReferenceNumber.indexOf( "/" );
            System.out.println( "PendingApplicationServlet iend: " + iend );
            /*
        ...
        catch ( ParseException | FileUploadException | DBException | SQLException ex ) {
...
//                Run and see System.out.println(" ");
        ...
        for ( int i = 0; i < filesToBeMoved.size(); i++ ) {
            ...
            switch ( decider ) {
                ...
                case "Contract":
                case "Translator_CV":
                    subDirectory = subDirs[8];  // Addendum
                    subNameDirectory = subDirs[9];  // Translator Name2
                    moveFileName = subDirs[10];  // addendum to the rights agreement 2.docx 
                ...
                case "CoverageCuttings":
                    ...
                    System.out.println( "filesToBeMoved--destinationDirectory--->>>> " + destinationDirectory );
                    moveFile = destinationDirectory + moveFileName;
                ...
                try {
                    ...
                    switch ( decider ) {
                        ...
                        case "Agreement":
                            ...
                            System.out.println( "insertAgreement:: ReferenceNumber  \n" + ReferenceNumber );
                            System.out.println( "insertAgreement:: rightsHolderArrayContent[0]  \n" + rightsHolderArrayContent[0] + " moveFileName " + moveFileName + " moveFileNameReplaced " + moveFileNameReplaced );
